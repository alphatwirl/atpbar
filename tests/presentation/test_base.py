...
param_names = "new_taskids, finishing_taskids, " "current_time, last_time, interval, expected"


@pytest.mark.parametrize(param_names, params)
def test_need_to_present(obj, mock_time, new_taskids, finishing_taskids, current_time, last_time, interval, expected):
