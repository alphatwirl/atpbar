...
def test_report_need_to_report(obj, monkeypatch, mock_queue, mock_time):
    ...
    report = ProgressReport('task1', 0, 10, taskid, pid=2342, in_main_thread=True)
    obj.report(report)
...
##__________________________________________________________________||
params = [
    pytest.param(ProgressReport('task1', 0, 10, 1, pid=2342, in_main_thread=True), {}, 10.0, True),
    pytest.param(ProgressReport('task1', 10, 10, 1, pid=2342, in_main_thread=True), {}, 10.0, True),
    pytest.param(ProgressReport('task1', 0, 10, 1, pid=2342, in_main_thread=True), {1: 10.0}, 10.0, True),
    pytest.param(ProgressReport('task1', 1, 10, 1, pid=2342, in_main_thread=True), {1: 10.0}, 30.0, True),
    pytest.param(ProgressReport('task1', 1, 10, 1, pid=2342, in_main_thread=True), {1: 10.0}, 15.0, False),
]
param_names = (
